...
var APIPerTemplateDefName = map[string]string{
	...
	"createcontainerservice":        "ecs",
	"createcontainertaskdefinition": "ecs",
	"attachcontainertaskdefinition": "ecs",
	"createuser":                    "iam",
	"deleteuser":                    "iam",
	"attachuser":                    "iam",
	"detachuser":                    "iam",
...
var AWSTemplatesDefinitions = map[string]template.Definition{
	...
	"createcontainerservice": {
		...
		Api:            "ecs",
		RequiredParams: []string{"cluster", "containertaskdefinition", "desired-count", "name"},
		ExtraParams:    []string{"role"},
	},
	"createcontainertaskdefinition": {
		Action:         "create",
		Entity:         "containertaskdefinition",
		Api:            "ecs",
		RequiredParams: []string{"name"},
		ExtraParams:    []string{},
	},
...
func DriverSupportedActions() map[string][]string {
	...
	supported["create"] = append(supported["create"], "containerservice")
	supported["create"] = append(supported["create"], "containertaskdefinition")
	supported["attach"] = append(supported["attach"], "containertaskdefinition")
