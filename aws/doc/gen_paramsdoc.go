...
var generatedParamsDoc = map[string]map[string]string{
	...
	"createdatabase": {
		...
		"backupwindow":      "Specifies the daily time range during which automated backups are created if automated backups are enabled, as determined by the BackupRetentionPeriod",
		...
		"dbsecuritygroups":  "Provides List of DB security group elements containing only DBSecurityGroup",
		...
		"public":            "Specifies the accessibility options for the DB instance",
